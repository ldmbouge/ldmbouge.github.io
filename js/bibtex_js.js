...
function BibtexParser() {
  ...
  this.entry_body = function(directive) {
    ...
    if (directive == "@INCOLLECTION"  || directive == "@INBOOK") {
      this.entries[this.currentEntry]["BIBTEXTYPE"] = "4. Book Chapters";
    } else if (directive == "@ARTICLE") {
	this.entries[this.currentEntry]["BIBTEXTYPE"] = "3. Journals";
    } else if (directive == "@INPROCEEDINGS") {
	this.entries[this.currentEntry]["BIBTEXTYPE"] = "5. Conferences";
    } else if (directive == "@PROCEEDINGS") {
	this.entries[this.currentEntry]["BIBTEXTYPE"] = "2. Edited Volumes";
    } else if (directive == "@BOOK") {
	this.entries[this.currentEntry]["BIBTEXTYPE"] = "1. Books";
    } else if (directive == "@TECHREPORT") {
	this.entries[this.currentEntry]["BIBTEXTYPE"] = "6. Technical reports";
    }   
    this.match(",");
    this.key_value_list();
  }
